...
invalid_jwt_body=$(echo "$invalid_jwt_response" | head -n -1)
...
empty_body_body=$(echo "$empty_body_response" | head -n -1)
...
invalid_json_body=$(echo "$invalid_json_response" | head -n -1)
