...
async function main() {
  ...
  console.log("✅ Voting 部署成功!");
  console.log("📍 合约地址:", votingAddress);
  console.log("🔗 Etherscan:", `https://sepolia.etherscan.io/address/${votingAddress}`);
  ...
  if (process.env.ETHERSCAN_API_KEY) {
    ...
    try {
      ...
      console.log("✅ Voting 合约验证成功!");
    } catch (error) {
      if (error.message.includes("Already Verified")) {
        console.log("✅ Voting 合约已验证过");
      } else {
        console.log("⚠️  Voting 合约验证失败:", error.message);
      }
    }
  } else {
